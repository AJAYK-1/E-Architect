                    ...
                    <nav>
                        ...
                        <ul class="menu">
                           <li><a href="AdminHome.php" >Home</a></li>
                            <li><a href="AdminAddPlan.php">Add Plan</a></li>
                           
                            <li><a href="AdminViewPlan.php">View Plan</a></li>
                            <li><a href="Admin Add Staff.php">Architect</a></li>
                            <li><a href="AdminViewFeedback.php">Feedback</a></li>
                            <li class="nav-right-sty mt-lg-0 mt-sm-4 mt-3">
                                <a href="CommonPage.php" class="reqe-button text-uppercase">Logout</a>
