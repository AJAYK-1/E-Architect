			...
			<div class="container">
				<div class="header-w3lsrow"> 
					<div class="menu"> 
						...
						<ul class="w3nav">
							<li><a href="CustomerHome.php" onclick="preventBack();" > Home</a></li>
							<li><a href="Customerviewarchitect.php" onclick="preventBack();">Architects</a></li>
							<li><a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Plans<span class="caret"></span></a>
								<ul class="dropdown-menu">
								<li><a href="CustomerDownloadPlan.php">View Plans</a></li>    
									<li><a href="CustomerApprovedPlan.php">Approved</a></li>  
								</ul>
							</li> 
